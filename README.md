...
Detailed building instructions with a complete .f3z-file can be found here on the [Instructables](https://www.instructables.com/3D-Printed-On-Road-RC-Race-Car/) website. The guide with all pictures was also transferred in this repository but it is easier to read at Instrucables and the .f3z-file is missing in this repository.
